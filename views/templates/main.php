...
<body>
    <header>
        <nav>
            ...
            <?php 
                // Si on est connecté, on affiche Admin, Monitoring et Déconnexion.
    ...
    <footer>
        <p>
            Copyright © Emilie Forteroche 2023 - Openclassrooms
            <!-- On peut garder le lien Admin ici, mais le menu l'affiche déjà -->
