    ...
    <?php 
        if (empty($comments)) {
            ...
            foreach ($comments as $comment) {
                ...
                // ----- Lien Supprimer visible uniquement si l'admin est connecté -----
                if (isset($_SESSION["user"])) {
                    echo '      <p class="commentActions">';
                    echo '          <a class="submit deleteComment" href="index.php?action=deleteComment&id=' . $comment->getId() . '" ' 
